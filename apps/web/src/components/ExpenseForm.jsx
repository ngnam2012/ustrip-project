...
import { categories } from "../pages/shared";

export function ExpenseForm({ tripId, expenseId, initialData, members, onClose, onSaved }) {
  ...
  return (
    <Modal title={expenseId ? "Sửa chi tiêu" : "Thêm chi tiêu"} onClose={onClose}>
      <form
